...
public final class CheckIdCard {
 ...
 /*   public static void main(String args[]) {
        System.out.println(new CheckIdCard("331002198903200035").validate());

        System.out.println(new CheckIdCard("331002198903200035").getGenderCode());

        System.out.println(new CheckIdCard("330802199108293225").getGenderCode());
    }*/
}
