...
import com.yanjinbin.mybatis.utils.IntrospectedTableTools;
    ...
    public void initialized(IntrospectedTable introspectedTable) {
        ...
        if (introspectedTable.getTableConfigurationProperty(PRO_TABLE_OVERRIDE) != null) {
            ...
            try {
                ...
                log.error("itfsw:插件" + this.getClass().getTypeName() + "使用tableOverride替换时异常！", e);
            }
            ...
            try {
                ...
                log.error("itfsw:插件" + this.getClass().getTypeName() + "使用searchString、replaceString替换时异常！", e);
            }
        }
    }
