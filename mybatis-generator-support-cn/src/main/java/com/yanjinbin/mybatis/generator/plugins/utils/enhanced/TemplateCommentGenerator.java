...
public class TemplateCommentGenerator implements CommentGenerator {
    ...
    public void addClassComment(InnerClass innerClass, IntrospectedTable introspectedTable) {
        if (innerClass instanceof com.itfsw.mybatis.generator.pluginsss.utils.enhanced.InnerInterfaceWrapperToInnerClass) {
            InnerInterface innerInterface = ((com.itfsw.mybatis.generator.pluginsss.utils.enhanced.InnerInterfaceWrapperToInnerClass) innerClass).getInnerInterface();
