...
package com.itfsw.mybatis.generator.pluginsss.utils.enhanced;
...
public class InnerInterfaceWrapperToInnerClass extends InnerClass{
    private com.itfsw.mybatis.generator.pluginsss.utils.enhanced.InnerInterface innerInterface;  // 内部接口
    ...
    public InnerInterfaceWrapperToInnerClass(com.itfsw.mybatis.generator.pluginsss.utils.enhanced.InnerInterface innerInterface) {
     ...
     * @author hewei
     */
    public com.itfsw.mybatis.generator.pluginsss.utils.enhanced.InnerInterface getInnerInterface() {
     ...
     * @author hewei
     */
    public void setInnerInterface(com.itfsw.mybatis.generator.pluginsss.utils.enhanced.InnerInterface innerInterface) {
        this.innerInterface = innerInterface;
    }
}
